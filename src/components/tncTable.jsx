...
import { TNCTABLE } from "../constants/pagesConstants"
import { SystemInfoApiData } from "../contextApi/systemInfo/systemInfoContextApi"
import { Link } from "react-router-dom"

const TncTable = () => {
  const { tncList, processDeleteTnc } = useContext(SystemInfoApiData)
            ...
            <tr key={item.id} className="border-t border-gray-200">
              ...
              <td className="w-1/4 border border-gray-200 py-4 px-2">
                <div className="flex space-x-2">
                  <Link
                    to={`/dashboard/editTnc/${item.id}/edit`}
