...
import { TEAMTABLE } from "../constants/pagesConstants"
import { SystemInfoApiData } from "../contextApi/systemInfo/systemInfoContextApi"
import { Link } from "react-router-dom"

const TeamTable = () => {
  const { teamList, processDeleteTeam } = useContext(SystemInfoApiData)
            ...
            <tr key={item.id} className="border-t border-gray-200">
              ...
              <td className="w-1/4 border border-gray-200 py-4 px-2">
                <div className="flex space-x-2">
                  <Link
                    to={`/dashboard/editTeam/${item.id}/edit`}
