...
const AddAbout = () => {
  const { processAddAbout } = useContext(SystemInfoApiData)
  ...
  const handleSubmit = async () => {
    let newData = {
      about: formData.question.level.content,
    }
    processAddAbout(newData)
  }
          ...
          <div className="flex flex-col mt-6">
            <div className="flex flex-col md:flex-row justify-center">
              ...
              <div className="w-full p-6 bg-gray-100 rounded-lg shadow-md mt-2 md:mt-0 md:m-2">
                <h2 className="text-lg font-semibold mb-2">{ADDABOUT.title}</h2>
