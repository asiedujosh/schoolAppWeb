...
import { ADDSLIDER } from "../constants/sliderConstants"
...
const AddSlider = () => {
  ...
  const handleSubmit = async () => {
    console.log("We are adding a slider")
  }
        ...
        <div className="w-90 m-6 md:mt-4 p-4 bg-white rounded shadow-lg">
          ...
          <div className="flex flex-col mt-6">
            <div className="flex flex-col md:flex-row justify-center">
              ...
              <div className="w-full p-6 bg-gray-100 rounded-lg shadow-md mt-2 md:mt-0 md:m-2">
                <div className="space-y-2">
                  {ADDSLIDER.fieldDetail.map((item) => {
                    return (
                      <InputField
                        field={item}
                        value={formData}
            ...
            <div className="mt-2 min-w-full flex items-center justify-center">
              <SubmitBtn text={ADDSLIDER.buttonText} submit={handleSubmit} />
            </div>
          </div>
        </div>
      </div>
